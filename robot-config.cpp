...
signature Vision__COLORRED = signature (1, 11171, 12499, 11835, -2101, -1347, -1724, 8.9, 0);
signature Vision__COLOR_YELLOW = signature (2, 0, 0, 0, 0, 0, 0, 3, 0);
vision Vision = vision (PORT19, 50, Vision__COLORRED, Vision__COLOR_YELLOW);
